...
$options = array (
  ...
  array(
    ...
    "desc" => '
      ...
      The data provided to your listing template has the following format: restaurants: Array [ restaurant: Object ]. Check the "restaurant" node in <a href="http://api.zuppler.com/v3/channels/demorestaurant/restaurants/demorestaurant.json" target="_blank">Demo Restaurant JSON</a> for more details about its structure.
    ' ),
