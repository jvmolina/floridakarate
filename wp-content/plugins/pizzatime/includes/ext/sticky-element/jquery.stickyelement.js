;(function(jQuery,win){
    ...
    jQuery.fn.sticky = function(parentName,options){
        ...
        this.each(function(){
            ...
            if(instance && (options || method)){
                ...
                jQuery.fn.sticky._instances.push(instance);
            }
        });
        return ret || this;
    };
    ...
    var updateAll = function(){
        var len = jQuery.fn.sticky._instances.length;
        for(var i = 0; i < len; i++){
            jQuery.fn.sticky._instances[i].update();
        }
    };

    jQuery.fn.sticky._instances = [];
    jQuery.fn.sticky.updateAll = updateAll;
    ...
    jQuery(win).on({
        ...
        'scroll':function(){
            ...
            var len = jQuery.fn.sticky._instances.length;
            for(var i = 0; i < len; i++){
                var element = jQuery.fn.sticky._instances[i];
                if(!element._frozen){
                    element.moveIt();
                }
            }
