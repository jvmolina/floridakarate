...
//echo "<pre>",print_r($subscription),"</pre>";die();
?>
		...
		<tr>
			...
			<td>
				<?php foreach ( $actions as $key => $action ) : 
				      	if($key="resubscriber"){$action['url']="https://hugtaste.com/plans/";}				
					?>
...
<?php if ( $notes = $subscription->get_customer_order_notes() ) :
	?>
	<h2>eeeeeeeeeeeee<?php esc_html_e( 'Subscription Updates', 'woocommerce-subscriptions' ); ?></h2>
